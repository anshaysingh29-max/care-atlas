...
import { BadgeIndianRupee, BedDouble, Bot, FileText, Files, FolderHeart, HeartPulse, LayoutDashboard, LogOut, MessageCircle, Plane, ShieldCheck, Star, UserCheck } from 'lucide-react';
...
const items = [
  ...
  ['/patient/discover', 'Discover Care', HeartPulse],
  ['/patient/concierge', 'AI Care Concierge', Bot],
