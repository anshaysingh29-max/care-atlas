  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid">
        ...
        <div><h4>Explore</h4><Link href="/treatments">Treatments</Link><Link href="/specialties">Specialties</Link><Link href="/destinations">Destinations</Link><Link href="/hospitals">Hospitals</Link><Link href="/care-navigator">AI Care Navigator</Link><Link href="/compare">Compare hospitals</Link></div>
      ...
      <div className="container footer-bottom">© 2026 CareAtlas. Healthcare without borders.</div>
    </footer>
  );
}
