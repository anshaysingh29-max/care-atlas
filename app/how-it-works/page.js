...
const steps = [
  ...
  [FileSearch, 'Share your case', 'Prepare a structured treatment request and organise the records you already have. Secure transmission will be enabled with the production backend.'],
...
export default function HowItWorksPage() {
  return (
    <>
      ...
      <section className="section section-soft"><div className="container partner-shell"><div><span className="eyebrow">READY TO BEGIN?</span><h2>Explore treatment options first.</h2><p>Phase 2 lets you build a structured case, compare hospitals and preview patient access alongside the discovery experience.</p></div><Link className="button" href="/get-treatment-plan">Start my case <ArrowRight size={17}/></Link></div></section>
    </>
  );
}
